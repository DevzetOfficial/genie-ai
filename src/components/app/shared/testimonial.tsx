...
const testimonials = [
    {
        id: 1,
        logo: false,
        review: "AI SDRs automate repetitive tasks, freeing up sales teams to focus",
        profileImg: profile,
    ...
    },
    {
        id: 3,
        logo: false,
        review: "“AI SDRs automate repetitive tasks, freeing up sales teams to focus on high-value activities, boosting overall productivity.”",
        profileImg: profile,
        reviewerName: "Jenny Wilson",
        designation: "IBM",
        bgColor: "#DAE6E3",
    ...
    },
    {
        id: 5,
        logo: false,
        review: "I SDRs automate repetitive tasks, freeing up sales teams to focus on high-value activities, boosting overall productivity.",
        profileImg: profile,
        reviewerName: "Jenny Wilson",
        designation: "IBM",
        bgColor: "#B6BBDC",
    ...
    return (
        <div className="flex flex-col gap-4 md:gap-6 lg:gap-8">
            <div className="grid gap-4 md:gap-6 lg:gap-8">
                {/* First Row: 3fr_3fr_6fr */}
                <div className="grid grid-cols-2   lg:grid-cols-12 gap-4 md:gap-6 lg:gap-8">
