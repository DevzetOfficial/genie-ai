...
const genieFeatures = [
  ...
  {
    text: "Business intelligence with real-time optimization.",
    iconSrc: checkIcon,
  },
  {
    text: "Streamlines pipelines & enhances customer satisfaction",
    iconSrc: checkIcon,
  },
  {
    text: "Integrates seamlessly with CRM, ERP, & analytics tools.",
    iconSrc: checkIcon,
  },
  {
    text: "Automates across departments, reducing workload",
    iconSrc: checkIcon,
  },
  {
    text: "Provides 24/7 support with seamless escalation",
    iconSrc: checkIcon,
  },
...
const otherAIFeatures = [
  ...
  {
    text: "Requires extensive customization to fit workflows.",
    iconSrc: xIcon,
  },
...
export const ComparisonTable: React.FC = () => {
  return (
    <div className="flex flex-wrap justify-center items-end text-base font-medium leading-snug">
      <div className="flex overflow-hidden flex-col rounded-l-[20px] border border-r-0 border-[#E9EAEC] min-w-[240px]  w-[252px]">
        {categories.map((category, index) => (
          <React.Fragment key={index}>
            <div
              className="flex gap-3 items-center py-5 pr-4 pl-6 w-full min-h-[60px] border-b last:border-b-0 border-[#E9EAEC] bg-white 
      ...
      <ComparisonColumn
        ...
        variant="dark"
        className="rounded-t-3xl overflow-hidden min-w-[240px] w-[505px] font-medium"
      />
      ...
      <ComparisonColumn
        ...
        variant="white"
        className="rounded-r-[20px] overflow-hidden border border-l-0 border-b-0  min-w-[240px] font-medium text-black text-opacity-70 w-[440px]"
      />
    </div>
  );
};
