...
function Agent() {
  return (
    <section className="section_gap">
      <div className="container flex flex-col gap-8 md:gap-16 max-w-[1064px]">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-14 lg:gap-28">
          {agentData.map((agent, index) => (
            ...
            >
              <div className="bg-[#EDF0F9] overflow-hidden aspect-[472/520] rounded-2xl md:rounded-[32px] duration-500">
                <img
                  loading="lazy"
                  src={agent.agentImg}
              ...
              <div className="flex flex-col mt-3 md:mt-5 w-full">
                ...
                <p className="mt-4 md:mt-5 w-full text-base leading-6 text-[rgba(1,6,9,0.70)] pb-4 md:pb-7 border-b border-black border-opacity-20">
                  {agent.about}
                </p>
              </div>
              ...
              <Link to={`${agent.route}`}>
                <button
                  type="button"
                  className="group-hover:text-primary transition-all duration-300 hover:pl-2 flex gap-4 justify-center items-center self-start mt-3 md:mt-5 text-xl font-medium leading-snug text-black"
                >
                  Learn more
                  <ArrowRight />
                </button>
